...
public class EstudianteControlador {
	...
	//este metodo sirve para guardar un estudiante
	@PostMapping("/estudiantes")
	public Estudiante guardarEstudiante(@RequestBody Estudiante estudiante) {
		return repositorio.save(estudiante);
	}
    
	//este metodo sirve para buscar un estudiante
	...
	//este metodo sirve para actualizar estudiante
	...
	//este metodo sirve para eliminar un estudiante
